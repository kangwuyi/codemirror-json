import LocalArrowRightArrowLeftIcon from 'codemirror-json/components/icon/arrow-right-arrow-left-solid.svelte'
import LocalCaretSquareDownIcon from 'codemirror-json/components/icon/square-caret-down-solid.svelte'
import LocalCaretSquareUpIcon from 'codemirror-json/components/icon/square-caret-up-solid.svelte'
import LocalCheckSquareIcon from 'codemirror-json/components/icon/square-check-solid.svelte'
import LocalCloneIcon from 'codemirror-json/components/icon/clone-solid.svelte'
import LocalCopyIcon from 'codemirror-json/components/icon/copy-solid.svelte'
import LocalCropAltIcon from 'codemirror-json/components/icon/crop-solid.svelte'
import LocalCutIcon from 'codemirror-json/components/icon/scissors-solid.svelte'
import LocalPasteIcon from 'codemirror-json/components/icon/paste-solid.svelte'
import LocalPenIcon from 'codemirror-json/components/icon/pen-solid.svelte'
import LocalPlusIcon from 'codemirror-json/components/icon/plus-solid.svelte'
...
import LocalTrashCanIcon from 'codemirror-json/components/icon/trash-can-solid.svelte'
